...
def migrate_data():
    ...
    try:
        ...
        targets_data = []
        print("Warning: 'targets.json' not found or is invalid. Skipping target migration.")
    ...
    try:
        ...
        evidence_data = []
        print("Warning: 'evidence.json' not found or is invalid. Skipping evidence migration.")
    ...
    with Session(engine) as session:
        ...
        for item in evidence_data:
            ...
            if target:
                ...
                existing_evidence = session.exec(select(Evidence).where(
                ...
                print(f"Warning: Could not find target '{target_name}' for an evidence record. Skipping.")
